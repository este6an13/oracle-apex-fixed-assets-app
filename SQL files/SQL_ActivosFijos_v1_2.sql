...
/* Created on:     14/06/2020 9:25:26 p. m.                     */
/*==============================================================*/
...
(
   ...
   MARCA_ACTIVO         VARCHAR2(15)         not null,
   VALOR_ACTIVO         NUMBER(8,2)          not null,
   DEPRECIACION_ACTIVO  NUMBER(5,2)          not null,
   ID_FUNCIONARIO       INTEGER,
   ID_EDIFICIO          INTEGER,
   ID_LOCACION          INTEGER,
   MATERIAL_ACTIVO      VARCHAR2(20),
   COLOR_ACTIVO         VARCHAR2(10),
   TAMANO_ACTIVO        VARCHAR2(20),
   COMPONENTES_ACTIVO   VARCHAR2(50),
...
(
   ...
   NOMBRE_FACULTAD      VARCHAR2(40)         not null,
...
(
   ...
   constraint PK_PROCEDIMIENTO primary key (ID_AUXILIAR, ID_ACTIVO)
);
