...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(30893855930451778129)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(30893855885603778129)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(30893855930451778129)
,p_button_name=>'CLOSE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(30893856003300778129)
,p_name=>unistr('Cerrar Recuadro de Di\00E1logo')
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(30893855885603778129)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(30893865848717778137)
,p_event_id=>wwv_flow_api.id(30893856003300778129)
,p_event_result=>'TRUE'
